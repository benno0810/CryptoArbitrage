...
class HuoBi:
    ...
    def __init__(self,config,name="HuoBi",currency="ethbtc"):
    ...
    def sell(self,volume,price=-1):
        try:
            ...
            accounts = self.get_accounts()
            acct_id = accounts['data'][0]['id'];
            print "12312479-132ry98qw3thf982qyhtgf089aqw23yht980f2yq0gf982qwayhfg243w8qh\t",acct_id
            _type = "sell-limit"
            params = {"account-id": acct_id,
                      "amount": str(volume),
                      "symbol": self.currency,
    ...
    def error(self,func,err):
        ...
        print >> sys.stderr, "HuoBiBB\t",func," error,", err
